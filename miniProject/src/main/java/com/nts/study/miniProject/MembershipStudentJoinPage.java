...
public class MembershipStudentJoinPage implements IMembership {
	...
	public MembershipStudentJoinPage(WebDriver driver) {
		this.driver = driver;
		driver.get("https://nid.naver.com/membership/join?m=joinStudent");
	}
